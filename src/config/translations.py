...
TRANSLATIONS = {
    ...
    "coins_menu_with_balance": "🛒 <b>Магазин валюты</b>\n\n💳 <b>Ваш баланс:</b>\n{accounts_info}\n\n🛍️ Здесь вы можете купить монеты для своих аккаунтов.",
    ...
    "no_registered_accounts": "❌ У вас нет зарегистрированных аккаунтов",
